...
Steps.defaultProps = {
  step1Title: 'Sign Up',
  step1Description:
    'Create an account on our platform to access all the features and music library.',
  step2Description:
    'Explore a vast collection of music from various genres and artists.',
  step4Title: 'Enjoy Anywhere',
  step3Description:
    'Organize your favorite tracks into personalized playlists that suit your mood.',
  step3Title: 'Create Playlists',
  step4Description:
    'Listen to your playlists and favorite songs anytime, anywhere, on any device.',
  step2Title: 'Discover Music',
}
